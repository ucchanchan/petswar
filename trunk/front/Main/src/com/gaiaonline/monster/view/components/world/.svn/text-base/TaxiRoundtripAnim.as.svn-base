...
package com.gaiaonline.monster.view.components.world {
    ...
    public class TaxiRoundtripAnim extends AsyncBase {
        ...
        public function TaxiRoundtripAnim(_arg1:ITaxi, _arg2:Asset, _arg3:WorldNode, _arg4:SoundProxy){
            this.taxi = _arg1;
            this.avatar = _arg2;
            this.homeX = _arg3.x;
            this.homeY = _arg3.y;
        ...
        private function onPickup():void{
            new GTween(this.avatar.self, DURATION, {scaleX:0.0001, scaleY:0.0001}, {onComplete:this.gotoHome});
        }
        private function gotoHome(_arg1:GTween):void{
