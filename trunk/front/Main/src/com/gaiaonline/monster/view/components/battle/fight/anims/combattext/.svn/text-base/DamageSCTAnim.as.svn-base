...
package com.gaiaonline.monster.view.components.battle.fight.anims.combattext {
    ...
    public class DamageSCTAnim extends BasicAnim {
        ...
        public function DamageSCTAnim(_arg1:DisplayObjectContainer, _arg2:Asset, _arg3:uint, _arg4:Boolean){
        ...
        override public function play():void{
            ...
            var _local1:TextField = MovieClip(this.content).wrapper.text;
            _local1.autoSize = TextFieldAutoSize.CENTER;
            _local1.text = this.value.toString();
