...
package alecmce.list.scrollbar {
    ...
    public class VScrollbar implements Scrollbar {
        ...
        public function setup(_arg1:uint, _arg2:uint):void{
            ...
            this.knob.scaleY = _local3;
            this.knob.y = (this.top = ((this.groove.y + this.grooveRectangle.top) - (this.knobRectangle.top * _local3)));
            this.bottom = ((this.groove.y + this.grooveRectangle.bottom) - (this.knobRectangle.bottom * _local3));
